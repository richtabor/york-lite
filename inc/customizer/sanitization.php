 ...
 */
function york_sanitize_image( $image, $setting ) {
	/*
 ...
 */
function york_sanitize_number_absint( $number, $setting ) {
 ...
 * @return int Sanitized number; otherwise, the setting default.
 */
function york_sanitize_number_intval( $int ) {
	return intval( $int );
}
